...
def hadamard(
  ...
  """
  had = _hadamard(power).astype(dtype)
...
def apply_hadamard_lhs_rhs(
  ...
  return apply_hadamard_lhs(act, had, lhs_reduction_dim), apply_hadamard_rhs(
...
def hadamard_rotate_inputs(
  ...
  act, weight = apply_hadamard_lhs_rhs(
