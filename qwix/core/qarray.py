...
def transpose_array(
  ...
  # reduce the transpose complexity here by calling squeeze first. For example,
  # for transpose [1, 2, None], instead of just calling transpose(1, 2, 0),
  # we call squeeze(0).expand(2).
