...
class AuxDataKey(str, enum.Enum):
  ...
  # Exact RHS permutation to replay before collapsed-einsum calibration.
  COLLAPSED_EINSUM_RHS_PERM = 'collapsed_einsum_rhs_perm'  # tuple[int, ...]


# Metadata keys that depend on the value being preserved.
# If the value changes (e.g. add, mul), these keys become invalid.
# IS_UNTRANSFORMED_WEIGHT is intentionally excluded from all propagation. A
