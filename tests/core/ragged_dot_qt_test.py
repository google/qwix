...
def ragged_dot_fq(
  ...
  lhs_how = ragged_dot.get_how_to_quantize(for_lhs=True, qtype=config.lhs_qtype)
  rhs_how = ragged_dot.get_how_to_quantize(
      for_lhs=False, qtype=config.rhs_qtype
  )
