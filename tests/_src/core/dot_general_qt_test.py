...
class DotGeneralQtTest(parameterized.TestCase):
  ...
  @parameterized.named_parameters(
      ...
      dict(
          ...
          residual_qtype='int8',
          expected_mae_fq_out=0.02,
          expected_mae_fq_grads=0.1,
          expected_mae_fp_out=0.5,
          expected_mae_fp_grads=0.5,
      ),
      dict(
          testcase_name='int4_original',
          lhs_qtype='int4',
          rhs_qtype='int4',
          bwd_qtype='int4',
          use_original_residuals=True,
  ...
  def test_grad_against_fq(
    ...
    config = dot_general_qt.DotGeneralQtConfig(
        ...
        use_original_residuals=use_original_residuals,
        dlhs_residual_qtype=residual_qtype,
        drhs_residual_qtype=residual_qtype,
    )
  ...
  def test_mxint8_sqnr(self):
    ...
    config = dot_general_qt.DotGeneralQtConfig(
        ...
        dlhs_residual_qtype='mxint8',
        drhs_residual_qtype='mxint8',
        tile_size=32,
        dlhs_tile_size=32,
        drhs_tile_size=32,
        use_original_residuals=False,
